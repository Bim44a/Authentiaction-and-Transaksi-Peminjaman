                        ...
                        <div class="card-body">
                            <form action="{{ route('transaksi.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    @enderror
                                    <small class="text-muted">Hanya anggota dengan status Aktif yang dapat
                                        meminjam</small>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('buku_id')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Hanya buku dengan stok tersedia yang dapat
                                        dipinjam</small>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('tanggal_pinjam')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Tanggal kembali otomatis 7 hari dari tanggal
                                        pinjam</small>
                                </div>
